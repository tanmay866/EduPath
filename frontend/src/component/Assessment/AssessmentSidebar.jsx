...
const AssessmentSidebar = () => {
  ...
  return (
    <div className="w-64 bg-gray-900 max-h-[70%] p-6 flex flex-col sticky top-0 h-screen overflow-y-auto relative">
      ...
      <div className="mt-auto pt-6 border-t border-gray-800">
        ...
        <button
          onClick={() => navigate("/")}
          className="w-full flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-all duration-200"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
