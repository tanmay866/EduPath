...
const CSFundamentals = () => {
        ...
        <div className="max-w-4xl w-full mx-auto relative z-10">
          <div className="backdrop-blur-xl bg-slate-900/60 rounded-2xl shadow-2xl border border-white/10 p-5">
            ...
            <div className="text-center mb-4">
              <div className="w-16 h-16 bg-emerald-500/20 text-emerald-400 rounded-2xl flex items-center justify-center mx-auto mb-2 border border-emerald-500/40">
                <Code size={32} strokeWidth={2} />
              </div>
              <h1 className="text-2xl font-bold text-white mb-0.5">CS Fundamentals Test</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
              ...
              <div className="bg-white/5 rounded-lg p-3 text-center">
                ...
                <div className="text-white font-bold text-lg">{quizConfig.difficulty}</div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-3 mb-4">
              <label className="flex items-start gap-3 cursor-pointer">
                <input
                  ...
                  className="mt-0.5 w-4 h-4 text-emerald-600 bg-slate-700 border-slate-600 rounded focus:ring-emerald-500 focus:ring-2"
                />
        ...
        <div className="max-w-6xl w-full mx-auto relative z-10">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-emerald-500/20 text-emerald-400 rounded-xl flex items-center justify-center border border-emerald-500/40">
                <Code size={20} strokeWidth={2} />
              </div>
              <div>
                <h1 className="text-xl font-bold text-white">CS Fundamentals Test</h1>
            ...
            <div className="flex items-center gap-3">
              <div className={`px-4 py-2 rounded-lg border ${isLowTime ? 'bg-red-900/50 border-red-500/50 animate-pulse' : 'bg-slate-800/50 border-white/10'}`}>
                <div className="flex items-center gap-2">
                  <Clock size={18} className={isLowTime ? 'text-red-400' : 'text-emerald-400'} />
              ...
              <div className="backdrop-blur-xl bg-slate-900/60 rounded-2xl shadow-2xl border border-white/10 p-6">
                ...
                <div className="flex gap-4 mt-6">
                  ...
                  {currentQuestionIndex === questions.length - 1 ? (
                    ...
                    <button
                      onClick={handleNext}
                      className="flex-1 px-6 py-3 bg-gradient-to-r from-emerald-600 to-green-600 text-white rounded-lg font-semibold hover:from-emerald-700 hover:to-green-700 transition-all transform hover:scale-[1.02] shadow-lg"
                    >
                      Next
                    </button>
                  )}
  ...
  if (stage === 'result' && result) {
    const getGrade = () => {
      ...
      if (result.percentage >= 70) return { grade: 'B', color: 'text-emerald-400', bg: 'bg-emerald-500/20' };
        ...
        <div className="max-w-2xl w-full mx-auto relative z-10">
          <div className="backdrop-blur-xl bg-slate-900/60 rounded-3xl shadow-2xl border border-white/10 p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-slate-300">Here's how you performed in CS Fundamentals</p>
            </div>
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10 mb-8">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-white font-bold">{quizConfig.difficulty}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-emerald-600 to-green-600 text-white rounded-xl font-semibold hover:from-emerald-700 hover:to-green-700 transition-all transform hover:scale-[1.02] shadow-lg"
              >
                <RotateCcw size={20} />
                Try Again
              </button>
